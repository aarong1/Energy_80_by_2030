...
#load data
data1 <- read_excel("./data/TDPNI_network_development_45_whole_projects_north_west_clean.xlsx") %>%
  clean_names() %>%
  mutate(
...
data2 <- read_excel("./data/TDPNI_network_development_45_whole_projects_south_east_clean.xlsx") %>%
  clean_names() %>%
  mutate(
    ecd_clean = ifelse(ecd == "TBC", NA, gsub("-.*", "", ecd)),
    ecd_clean = as.numeric(ecd_clean),
...
data3 <- read_excel("./data/TDPNI_network_development_45_whole_projects_both_area_clean.xlsx") %>%
  clean_names() %>%
  mutate(
    ecd_clean = ifelse(ecd == "TBC", NA, gsub("-.*", "", ecd)),
    ecd_clean = as.numeric(ecd_clean),
...
data4 <- read_excel("./data/TDPNI_network_development_45_projects_changes_clean.xlsx") %>%
  clean_names() %>%
...
data5 <- read_excel("./data/TDPNI_network_development_45_new_projects_clean.xlsx") %>%
  clean_names()

data6 <- read_excel("./data/TDPNI_asset_replacement_rp6_clean.xlsx") %>%
  clean_names() %>%
  mutate(
    ecd_clean = ifelse(ecd == "TBC", NA, gsub("-.*", "", ecd)),
    ecd_clean = as.numeric(ecd_clean),
...
data7 <- read_excel("./data/TDPNI_asset_replacement_rp7_clean.xlsx") %>%
  clean_names() %>%
  mutate(
    ecd_clean = ifelse(ecd == "TBC", NA, gsub("-.*", "", ecd)),
    ecd_clean = as.numeric(ecd_clean),
...
data8 <- read_excel("./data/TDPNI_asset_replacement_d5_clean.xlsx") %>%
  clean_names() %>%
  mutate(
    ecd_clean = ifelse(ecd == "TBC", NA, gsub("-.*", "", ecd)),
    ecd_clean = as.numeric(ecd_clean),
