...
div(style = 'position:sticky; top:8%; height:90vh;',
    ...
    div(class = 'py-2 px-5 me-5  rounded-5 position-relative',#offset = 1, mx-5
        ...
        div(class = 'alert alert-light',
            ...
            h3(textOutput(inline = T, 'target_pct_target_date1'),"%"),
            #h5( "2 MW/yr"),
        ...
        div(
          ...
          h4(span(textOutput(inline = T,'total_new_res_target_date1'),"MW/yr")),
          #h4( "2 MW/yr"),
        ...
        div(
          ...
          tags$small(class = 'text-muted', 'Annual New Capacity'),
          # h5( "2 MW/yr"),
          h5(textOutput(inline = T,'new_res_preplanning_cumulative_target_date1'),'MW'),
